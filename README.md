...
1. **加载文件 1**: 点击"文件 1"的"选择文件"按钮，选择 TXT 或 Word 文件
2. **加载文件 2**: 点击"文件 2"的"选择文件"按钮，选择要比对的文件
